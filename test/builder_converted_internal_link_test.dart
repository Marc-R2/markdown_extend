...
void main() {
  ...
  const convertedFile0 = InternalLinkConverted(tokenAtomic0, convertedText0);
  const convertedFile1 = InternalLinkConverted(tokenAtomic1, convertedText1);

  setUp(() {
    builder = Builder();
  });

  test('create InternalLinkConverted with TokenAtomic', () {
    ...
    expect(build, contains('const  var2 = InternalLinkConverted(var0, var1);'));
  });

  test('create InternalLinkConverted with TokenGroup', () {
    ...
    expect(build, contains('const  var4 = InternalLinkConverted(var2, var3);'));
  });

  test('create same InternalLinkConverted twice', () {
