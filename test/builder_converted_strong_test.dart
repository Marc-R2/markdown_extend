...
void main() {
  ...
  const convertedStrong0 = ConvertedStrong(convertedText0);
  const convertedText1 = ConvertedText(tokenGroup0);
  const convertedStrong1 = ConvertedStrong(convertedText1);

  setUp(() {
    builder = Builder();
  });

  test('create ConvertedStrong with TokenAtomic', () {
    convertedStrong0.build(builder);
    ...
    expect(build, contains('const  var2 = ConvertedStrong(var1);'));
  });

  test('create ConvertedStrong with TokenGroup', () {
    convertedStrong1.build(builder);
    ...
    expect(build, contains('const  var4 = ConvertedStrong(var3);'));
  });

  test('create same ConvertedStrong twice', () {
    final var0 = convertedStrong1.build(builder);
    final var1 = convertedStrong1.build(builder);
